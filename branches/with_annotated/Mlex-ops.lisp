...
#|Basic Lexical Operators
  Mlex-ops.lisp
  Contents: Basic lexical operators:
            concat
            blocks
            split-at-delimiter
            span
            splitoff-prefix
            split-on-token
  Notes: This file correctly and efficiently implements all the 
         requirements of the functions defined in iEx1.
|#
